...
============================================================= -->
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0" id="t3">
			...
			<tr>
				<th colspan="7" style="background:#FFFFFF;" ><span style="float:right;"><A HREF="http://p.mijie.org/php/p.zip">探针下载</A></span><b>〖AD〗</b><a href="http://mijie.org" target="_blank">域名注册</a> | <a href="http://mijie.org" target="_blank">虚拟主机</a> | <a href="http://mijie.org" target="_blank">美国VPS</a> | <a href="http://mijie.org" target="_blank">域名交易</a> | <a href="http://mijie.org" target="_blank">免费域名注册</a>
				</th>
			</tr>
		</table>
<?php
...
============================================================== -->
	...
	echo $gdInfo_a?$gdInfo_a:NO;?></td>
				...
				<td><?php if((phpversion('eAccelerator'))!='')
					echo "<span class='resYes'>YES</span> 版本:".phpversion('eAccelerator');
		 else echo "<span class='resNo'>NO</span>"; ?></td>
			</tr>
			<tr>
				<td>支持Zend Optimizer编译运行</td>
				<td><?php if(function_exists('zend_optimizer_version'))
					echo "<span class='resYes'>YES</span> 版本:".zend_optimizer_version();
		 else echo (get_cfg_var("zend_optimizer.optimization_level")||get_cfg_var("zend_extension_manager.optimizer_ts")||get_cfg_var("zend.ze1_compatibility_mode")||get_cfg_var("zend_extension_ts"))?YES:NO ;?></td>
			</tr>
			<tr>
				<td>支持ioncube编译运行</td>
		 ...
		 echo "<span class='resYes'>YES</span> 版本:".ionCube_Loader_version().$gm;}
...
============================================================== -->
		<div id="footer" align="right" style="margin:20px 0px 20px 0px;">
			...
			<span style="float:left;">Power by: <A HREF="http://www.mijie.orgt" target="_blank">MiJie.Org</A></span>页面执行时间<?php echo $pagetime;?>秒&nbsp;&nbsp;<a name="bottom"></a><a href="#top" class="arrow">55</a>
		</div>
	</div>
</form>
</body>
