<?php
/******************************************************************/
/*  由iProber修改 参考X-Prober  B-Check 浪点PHP探针 PhpSpy  而成  */
/*                              逍遥混世修改版                    */
/*                                                     2009.04.05 */
/******************************************************************/
...
$stylevar[ggad] = '<script type="text/javascript">
</script>';
$stylevar[AD] = '<a href="http://ltmp.net/" target="_blank">LTMP.NET</a>&nbsp;';//这个最好别修改
    $mysqlReShow = "none";
    $mailReShow = "none";
    $funReShow = "none";
    $opReShow = "none";
...
<title>PHP探针 iProber 逍遥混世修改版</title>
<meta name="keywords" content="php探针,探针程序,php探针程序,探针,iProber,逍遥混世" />
<style type="text/css">
<!--
...
td,th { padding:3px; background:#363835; }
...
页头 
============================================================= -->
		<h1><i><b>逍</b>遥混世</i><span><i>修改版</i></span></h1>
		<a name="top"></a>
		<p id="t12">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0" id="t3">
			<tr>
				...
				<td><a href="<?php echo PHPSELF;?>" class="t211">刷新</a></td>
				<td><a href="#bottom" class="arrow">66</a></td>
			</tr>
			<tr>
				<th colspan="7">
				<div style="float:left;width:18%"><font color="#343525"><b>〖AD〗</b></font>
				<?php echo $stylevar['AD'];?></div>
				<div style="float:left;width:66%">
				<?php echo $stylevar['ggad'];?></div>
				<div style="float:right;width:16%;text-align:right;"><a href=" http://www.78300.com/tz.zip">点击下载最新版探针</a></div>
</th>
			</tr>
		</table>
<?php
...
中央处理芯片检测信息
============================================================= -->
<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\"><tr><th colspan=\"5\"><span>8</span>中央处理芯片检测信息</th></tr><tr><td colspan=\"5\"><tr><td>编号</td><td>类型</td><td>内核</td><td>频率</td><td>L2缓存</td></tr>";
			...
			$cpu_c = $data['vendor_id']?"</td></tr></table>":"";
			echo $cpu_c;
		}									
		unset($data);
	}
...
中央处理芯片检测信息
============================================================= -->
<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\"><tr><th colspan=\"5\"><span>8</span>中央处理芯片检测信息</th></tr><td colspan=\"3\"><tr><td>CPU个数</td><td>内核</td><td>L2缓存</td></tr><tr><td>$cpunum</td><td>$cpumodel</td><td>$cpucache</td></tr></td></tr></table>":"";
$cpu_cpu =$rs?"":$x_cpu;
echo $cpu_cpu;
if (PHP_OS=="WINNT"){
...
中央处理芯片检测信息
============================================================= -->
<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\"><tr><th colspan=\"5\"><span>8</span>中央处理芯片检测信息</th></tr><td colspan=\"3\"><tr><td>CPU个数</td><td>内核+类型</td><td>运行级别</td><td>版本</td></tr><tr><td>$cpu1</td><td>$cpu2</td><td>$cpu3</td><td>$cpu4</td></tr></td></tr></table>":"";
			echo $cpu;
}
//以上CPU检测信息结束
?>
...
============================================================= -->
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
			...
			<tr>
				...
				<td width="80%"><?php echo date("Y年n月j日 H:i:s");?>
					&nbsp;北京时间：
...
//		echo "磁盘容量：".$diskum;
 ...
 <!-- 如果系统不是WINNT的，不显示以上信息 -->
 			<tr>
				<td>目前还有空余空间</td>
				<td><?php echo round((@disk_free_space(".")/(1024*1024)),2) ? round((@disk_free_space(".")/(1024*1024)),2) : intval(diskfreespace("/") / (1024 * 1024));?>
					M</td>
			</tr>
			<?php
			...
			<tr>
				...
				<td> 物理内存：共
					...
					% &nbsp;(类似Apache或Nginx会开辟Cache化内存加速网页或脚本存取)
					<?php echo bar($sysInfo['memPercent']);?>
					(不含Cache内存部分的<b>真实内存使用率为
...
?>
			...
			<tr>
				<td>DreamHost Apps主机 (2009/02/09 22:23)</td>
				<td> 0.484秒</td>
				<td> 0.489秒</td>
				<td> 0.061秒</td>
			</tr>
			<tr>
				<td>Lunarpages虚拟主机 (2009/02/09 22:30)</td>
				<td> 0.687秒</td>
				<td> 0.684秒</td>
				<td> 0.125秒</td>
			</tr>
			<tr>
				<td>UnlimitedMB免费主机 (2009/02/09 22:33)</td>
				<td> 0.151秒</td>
				<td> 0.15秒</td>
				<td> 0.053秒</td>
			</tr>
				<tr>
				<td>000webhost免费主机 (2009/02/09 22:37)</td>
				<td> 0.345秒</td>
				<td> 0.331秒</td>
				<td> 0.091秒</td>
			</tr>
			<tr>
				<td>51.net虎翼网的门户通 (2009/02/09 22:50)</td>
				<td> 0.167秒</td>
				<td> 0.169秒</td>
				<td> 0.073秒</td>
			</tr>
...
============================================================== -->
		<div id="footer">
		<?php $url="http://www.78300.cn"; $self = $_SERVER['PHP_SELF'];?>
			<p id="f1">
				<a name="bottom"></a>
			...
			<table  border="0" cellspacing="1" cellpadding="0" id="f3">
				<tr>
					...
					<td id="f32"><a href="<?php echo $url;?>"><b>逍遥混世</b></a>
					</td>
				</tr>
			</table>
		</div>
